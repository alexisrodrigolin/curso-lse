...
int main(void) {
	...
	xTaskCreate(task_display_change, "Display change", tskDISPLAY_CHANGE_STACK, NULL, tskDISPLAY_CHANGE_PRIORITY, &handle_display);
	xTaskCreate(task_usr, "usr button", tskUSR_STACK, NULL, tskUSR_PRIORITY, &handle_display);
